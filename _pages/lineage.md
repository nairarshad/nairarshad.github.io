...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/lineage/nair.png" alt="Arshad Arjunan Nair" style="width: 150px; margin-right: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/lineage/yu.png" alt="Fangqun Yu" style="width: 150px; margin-right: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/turco.png" alt="Richard Peter Turco" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Richard Peter Turco</strong> <br />
    ...
    <em>under the (primary) advisement of</em>
  </div>
</div>

<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/sechrist.png" alt="Chalmers Franklin Sechrist, Jr." style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Chalmers Franklin Sechrist, Jr.</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/mentzer.png" alt="John R. (Jack Raymond) Mentzer" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>John R. (Jack Raymond) Mentzer</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/prebus.png" alt="Albert Frederick Prebus" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Albert Frederick Prebus</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/burton.png" alt="Eli Franklin Burton" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Eli Franklin Burton</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/mclennan.png" alt="Sir John Cunningham McLennan" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Sir John Cunningham McLennan</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/thomson.png" alt="Sir Joseph John 'JJ' Thomson" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Sir Joseph John 'JJ' Thomson</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/rayleigh.png" alt="Lord Rayleigh (John William Strutt)" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Lord Rayleigh (John William Strutt)</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/routh.png" alt="Edward John Routh" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Edward John Routh</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/hopkins.png" alt="William Hopkins" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>William Hopkins</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/sedgwick.png" alt="Adam Sedgwick" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Adam Sedgwick</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/jones.png" alt="Thomas Jones" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Thomas Jones</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/postlethwaite.png" alt="Thomas Postlethwaite" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Thomas Postlethwaite</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/whisson.png" alt="Stephen Whisson" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Stephen Whisson</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/taylor.png" alt="Walter Taylor" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Walter Taylor</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/smith.png" alt="Robert Smith" style="width: 150px; margin-right: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/cotes.png" alt="Roger Cotes" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Roger Cotes</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/newton.png" alt="Isaac Newton" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Isaac Newton</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/barrow.png" alt="Isaac Barrow" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Isaac Barrow</strong> <br />
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/viviani.png" alt="Vincenzo Viviani" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Vincenzo Viviani</strong> <br />
    Known for: Viviani's theorem <br />
    Universit&agrave; di Pisa 1642 <br />
    <em>under the (primary) advisement of</em>
  </div>
</div>

<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/galileo.png" alt="Galileo Galilei" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Galileo Galilei</strong> <br />
    Known for: Analytical dynamics, Heliocentrism <br />
    Universit&agrave; di Pisa 1585 <br />
    <em>under the advisement of</em>
  </div>
</div>

<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/ricci.png" alt="Ostilio Ricci" style="width: 150px; margin-right: 20px;">
  <div>
    <strong>Ostilio Ricci</strong> <br />
    Known for: Teaching Galileo the mathematics of Euclid and Archimedes <br />
    Universit&agrave; di Brescia <br />
    <em>under the advisement of</em>
  </div>
</div>

<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/tartaglia.png" alt="Niccol&ograve; Fontana Tartaglia" style="width: 150px; margin-right: 20px;">
  <div>
...
<div style="display: flex; align-items: center; margin-bottom: 20px;">
  <img src="/files/alkhwarizmi.png" alt="Muhammad ibn Musa Al-Khwarizmi" style="width: 150px; margin-right: 20px;">
  <div>
